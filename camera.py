...
music_dist={0:"food/angry.csv",1:"food/disgusted.csv ",2:"food/fearful.csv",3:"food/happy.csv",4:"food/neutral.csv",5:"food/sad.csv",6:"food/surprised.csv"}
global last_frame1                                    
...
class VideoCamera(object):
	...
	def get_frame(self):
		...
		return jpeg.tobytes(), df1 ,emo

def music_rec():
	# print('---------------- Value ------------', music_dist[show_text[0]])
	df = pd.read_csv(music_dist[show_text[0]])
	df = df[['Foods','Type','Restaurant']]
	df = df.head(15)
	return df
